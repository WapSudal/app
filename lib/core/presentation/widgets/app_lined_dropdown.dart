...
class AppLinedDropdown<T> extends StatefulWidget {
  const AppLinedDropdown({
    super.key,
    required this.items,
    this.value,
    this.onChanged,
  ...
  @override
  State<AppLinedDropdown<T>> createState() => _AppLinedDropdownState<T>();
}

class _AppLinedDropdownState<T> extends State<AppLinedDropdown<T>>
  ...
  @override
  void didUpdateWidget(covariant AppLinedDropdown<T> oldWidget) {
              ...
              child: AnimatedBuilder(
                ...
                builder: (context, child) {
                  return Stack(
                    ...
                    children: [
                      // Main dropdown container (Bottom border only)
                      AnimatedContainer(
