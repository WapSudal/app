...
class _AppOutlinedTextFieldState extends State<AppOutlinedTextField>
  ...
  @override
  void didUpdateWidget(covariant AppOutlinedTextField oldWidget) {
                  ...
                  child: Row(
                    ...
                    children: [
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(
                            left: widget.prefixIcon != null
                                ? 8
                                : FormFieldTokens.outlinedHorizontalPadding,
                            right:
                      ...
                      if (_shouldShowClearButton) ...[
                        ...
                        Padding(
                          padding: const EdgeInsets.only(
                            right: FormFieldTokens.outlinedHorizontalPadding,
                          ),
                ...
                Positioned(
                  left: widget.prefixIcon != null
                      ? FormFieldTokens.outlinedHorizontalPadding +
                            32 +
                            8 // prefix icon 너비 + 여백
                      : FormFieldTokens.outlinedHorizontalPadding - 1,
                  top: 0,
  ...
  Widget _buildClearButton() {
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Container(
          width:
              FormFieldTokens.clearButtonSize +
              FormFieldTokens.outlinedHorizontalPadding,
          height: FormFieldTokens.clearButtonSize,
          alignment: Alignment.center,
          padding: const EdgeInsets.only(
            right: FormFieldTokens.outlinedHorizontalPadding - 8,
          ),
          child: Icon(
            Icons.cancel_rounded,
            color: AppColorScheme.white500,
            size: FormFieldTokens.clearButtonSize - 4, // 약간 작게
          ),
        ),
      ),
    );
