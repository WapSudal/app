...
import 'what_if_widgets.dart';

class WhatIfSimulationContent extends StatefulWidget {
  const WhatIfSimulationContent({super.key, required this.simulation});

  final WhatIfSimulationReportEntity simulation;

  @override
  State<WhatIfSimulationContent> createState() =>
      _WhatIfSimulationContentState();
}

class _WhatIfSimulationContentState extends State<WhatIfSimulationContent> {
